...
def _get_attention_functions() -> tuple[Callable, Callable, Callable, Callable]:
    ...
    if is_torch_npu_available(check_device=False):
        ...
        # The newversion requirements intentionally leave flash-attn commented
        # out.  Transformers 4.57 ships equivalent padding primitives, which
        # are sufficient for the non-fused SDPA canary and avoid a source build
        # on SM120.  Prefer the native implementation whenever it is present.
        try:
