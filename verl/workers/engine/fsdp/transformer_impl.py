...
class FSDPEngine(BaseEngine):
    ...
    def _build_lora_module(self, module):
        ...
        if lora_adapter_path is not None:
            ...
            # Keep newly created LoRA parameters in the same dtype as the
            # frozen base model before FSDP flattens parameter groups.  PEFT
            # initializes adapters in fp32 by default; mixed-dtype flat
            # parameters can otherwise trigger CPU/CUDA gradient placement
            # errors with recent PyTorch/FSDP releases.
